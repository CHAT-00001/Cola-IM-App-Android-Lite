...
public class MobShareUtil {
    ...
    /**
     * 3个参数的方法（兼容旧代码，内部自动获取 app_name）
     */
    public void execute(String platType, ShareData data, MobCallback callback) {
        String appName = WordUtil.getString(R.string.app_name);
        execute(platType, data, callback, appName);
    }

    /**
     * 4个参数的方法（可以自定义 app_name）
     */
    public void execute(String platType, ShareData data, MobCallback callback, String appName) {
